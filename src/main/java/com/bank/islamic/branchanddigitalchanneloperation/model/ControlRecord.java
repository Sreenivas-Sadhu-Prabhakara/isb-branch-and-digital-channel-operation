package com.bank.islamic.branchanddigitalchanneloperation.model;
...
/**
 * The BIAN control record for this service domain: "Channel Session Operating Session".
 *
 ...
 * to its asset type (Channel Session). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Channel Session Operating Session";
